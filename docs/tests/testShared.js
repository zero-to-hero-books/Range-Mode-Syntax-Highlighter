...
function addContents(sel){
	...
	contents.push({str:"Performance tests"});
	contents.push({str:"RangeModeSyntaxHighlighter.js", href:"./perfAll.html"});
	


	contents.forEach(function(obj,idx){
...
var Test=(function () {
	...
	function load(tArgs, tCode, tExpected){
		var elements=Array.prototype.slice.call(id('testForm').querySelectorAll('.arg'));
